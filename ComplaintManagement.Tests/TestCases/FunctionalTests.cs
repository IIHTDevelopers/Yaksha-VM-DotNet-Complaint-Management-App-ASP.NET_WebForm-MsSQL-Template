...
namespace ComplaintManagementApp.Tests.TestCases
{
    public class FunctionalTests
    {
        ...
        [Fact]
        public async Task<bool> Testfor_Update_Complaint_NotNull()
        {
            //Arrange
            var res = false;
        ...
        [Fact]
        public async Task<bool> Testfor_GetAll_Complaint_NotNull()
        {
            //Arrange
            var res = false;
            string testName; string status;
        ...
        [Fact]
        public async Task<bool> Testfor_UpdateComplaint_ReturnsString()
        {
            //Arrange
            var res = false;
            string testName; string status;
        ...
        [Fact]
        public async Task<bool> Testfor_AllComplaint_ReturnsString()
        {
            //Arrange
            var res = false;
            string testName; string status;
