<%@ Page Title="ComplaintManagement" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ComplaintManagement.aspx.cs" Inherits="ComplaintManagementApp.ComplaintManagement" %>
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-md-offset-1">
                                        <div class="form-group">
                                          <asp:Label runat="server" AssociatedControlID="txtTitle"><b>Complaint Title</b></asp:Label><br />
                                          <asp:TextBox runat="server" required="required" Enabled="True" name="BrandName" ID="txtTitle" class="form-control input-sm" placeholder="Complaint Title"></asp:TextBox>

                                       </div> 
                                   </div>
                                      <div class="col-md-4 col-md-offset-1">
                                        <div class="form-group">
                                          <asp:Label runat="server" AssociatedControlID="txtIsResolved"><b>Is complaint resolved?</b></asp:Label><br />
                                          <asp:TextBox runat="server" required="required" Enabled="True" name="BrandName" ID="txtIsResolved" class="form-control input-sm" placeholder="Complaint Title"></asp:TextBox>
